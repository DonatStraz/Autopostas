@if(count($reviews) > 0)
        @foreach($reviews as $review)
                ...
                <div class="car-info col-span-1">
                    ...
                    <div class="flex flex-col items-center  bg-slate-100 pb-2 md:pb-2">
                        ...
                        <div class="flex justify-center">
                            ...
                            <div class="mt-1.5 flex ">Automobilio reitingas @php echo round($rating, 2) @endphp
            ...
            @endforeach
                {{ $reviews->links() }}
            @else
                <div class="m-2 mt-8">Atsiliepimų apie šį modelį dar nėra
                <a class="text-lime-600 p-2" href="/rasyti-atsiliepima/{{$car->id}}">Būk pirmas</a></div>
            @endif
