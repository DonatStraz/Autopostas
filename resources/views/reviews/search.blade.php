<x-app-layout>
    <div class="container mx-auto mt-5">
        <section class="search-section bg-no-repeat bg-center text-xl text-white">
            <form action="" method="Get" class=" text-slate-500 mt-1 text-2xl p-2.5 flex flex-col  items-center my-5">
            <div class="flex">
                ...
                <div class="search relative ">
                    <button id="search-btn" class="bg-zinc-500 text-white p-1.5 text-xl hover:bg-gray-700 transition ease-in-out">Ieškoti</button>
                </div>
            </div>
            </form>
        </section>
            ...
            <div class="review-card grid grid-cols-3 mt-5 mx-2 border-b-4 border-slate-200">
                ...
                <div class="flex items-center sm:justify-between flex-col sm:flex-row  col-span-2 my-3">
                    <div class="flex flex-col items-center">
                        <div class="car-title text-xl md:ml-2">Bmw 3 Serija E46</div>
                    ...
                    <div>
                    <a class="bg-amber-400 text-xl p-1 rounded " href="#">Parašyti atsiliepimą</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container lg:w-6/12 md:mx-auto">
        <div class="review-cards">
            <div class="review-card grid grid-cols-3 mt-5 mx-2 border-b-4 border-slate-200">
                <div class="col-span-1">
                        <img  src="{{ asset('images/escalade.jpg')}}">
                </div>
                <div class="flex items-center sm:justify-between flex-col sm:flex-row  col-span-2 my-3">
                    <div class="flex flex-col items-center">
                        <div class="car-title text-xl md:ml-2">Bmw 3 Serija E46</div>
